  ...
  {isModalOpen && (
   ...
   <div className="text-center max-w-xl -mt-24">
       ...
       <ul className="flex flex-col items-center">
           <li>
               <button
                   className="transform transition duration-500 ease-in-out hover:scale-105 inline-flex items-center mt-1 justify-center rounded-md bg-white px-4 py-2 text-center text-lg lg:text-xl font-medium text-gray-900 focus:outline-none border border-gray-200 hover:bg-gray-100 hover:text-blue-700"
                   onClick={openModal}
               >
                   Saber más
               </button>
                    ...
                    <div className="flex flex-col-reverse lg:flex-row items-center ml-0 lg:ml-[250px]">
                        <div className="max-w-xl -mt-8">
                            ...
                            <ul className="flex flex-wrap items-center">
                                <li>
                                    <button
                                        className="transform transition duration-500 ease-in-out hover:scale-105 inline-flex items-center mt-4 ml-4 justify-center rounded-md bg-white px-6 py-3 text-center text-xl lg:text-2xl font-medium text-gray-900 focus:outline-none border border-gray-200 hover:bg-gray-100 hover:text-blue-700"
                                        onClick={openModal}
                                    >
                                        Saber más
                                    </button>
                                ...
                                <animated.div style={imageAnimation}>
                                    <div className="py-3 sm:py-4">
                                        <img
                                            src={foto1}
                                            alt=""
                                            className="w-full rounded-3xl transform transition duration-500 ease-in-out hover:scale-105 "
                                        />
                                    </div>
                                </animated.div>
                                <animated.div style={imageAnimation}>
