...
import blogs from "../assets/student.jpg";
import blogsSmall from "../assets/student.jpg";
        ...
        <div className="content-container py-8 mx-auto flex flex-col ">
          ...
          <animated.div style={imageAnimation} className="w-full flex justify-center mt-4 image-container">
            <div style={{ backgroundImage: `url(${fondo_image})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat' }}>
              <img src={blogsSmall} alt="hero" className="max-w-full w-[325px] transform transition duration-500 ease-in-out hover:scale-105 rounded-3xl" />
            </div>
          </animated.div>
        </div>
        ...
        <div className="content-container py-8 mx-auto relative">
          <div className="flex flex-col-reverse lg:flex-row items-center ml-0 lg:ml-[250px]">
            <div className="max-w-xl -mt-8">
              <h2 className="text-4xl font-bold tracking-tight text-rose-600 sm:text-5xl font-popping text-[#b5d3f8] mb-4">
              Habla inglés en 8 meses con nuestro metodo divertido y enfocado a la práctica 
              </h2>
            ...
            <div className="w-[400px] lg:w-1/3 flex items-center flex-grow ml-0 order-1 lg:order-2 lg:ml-48">
              <div className="w-full lg:w-2/3 flex justify-center mb-8 lg:mb-0 order-2 lg:order-1 image-container">
                <animated.div style={imageAnimation}>
                  <div style={{ backgroundImage: `url(${fondo_image})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat' }}>
                    <img src={blogs} alt="hero" className="max-w-full lg:ml-auto w-[650px] transform transition duration-500 ease-in-out hover:scale-105 rounded-3xl" />
                  </div>
                </animated.div>
              </div>
            </div>
