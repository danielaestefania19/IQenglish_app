...
function Home() {
  ...
  return (
    <section className="bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
     <div style={{ marginLeft: '7rem' }} className="py-8 px-4 max-w-screen-xl text-center lg:py-16 z-10 relative container mx-auto">
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">¡Nosotros creemos en tu potencial!</h1>
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-12 lg:px-44 dark:text-gray-200">{motivationalPhrase}</p>
