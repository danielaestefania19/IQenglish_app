...
const Card = () => {
    return (
        ...
        <section className="bg-gradient-to-br from-black to-gray-800 w-full h-full pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
                ...
                <h2
                  className="mb-4 text-3xl font-bold text-dark text-white sm:text-4xl md:text-[40px]"
                >
                 IQENGLISH LIVE
                </h2>
