            ...
            <div>
              ...
              >
                <ul className="block lg:flex">
                  ...
                  <li>
                    <a href="javascript:void(0)" className="flex font-montserrat py-2 text-base font-medium text-dark hover:text-primary dark:text-white lg:ml-10 lg:inline-flex">
                      Metodo
                    </a>
                  </li>
                  <li>
