            ...
            <div className="content-container py-8 mx-auto relative " >
                <div className="flex flex-col-reverse lg:flex-row items-center ml-0 lg:ml-[250px]" >
                    <div className="max-w-xl -mt-24">
                        ...
                        <p className="mb-2 max-w-[600px] text-xl lg:text-2xl dark:text-dark-6 font-popping text-[#F0F4F9]" style={{ letterSpacing: '-0.01em' }}> La forma más fácil de aprender inglés, Domina el inglés para ampliar tus oportunidades profesionales y personales.</p>
