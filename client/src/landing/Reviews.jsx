...
const Reviews = () => {
  ...
  const closeModal = () => {
    ...
    // Reset the comment field when closing the modal
    setComment('');
  };
  ...
  const handleSubmit = (event) => {
    ...
    // Here you can handle the submission of the comment, e.g., send it to a server
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                          <textarea
                            ...
                            className="block w-full h-32 px-3 py-2 mt-1 border border-gray-300 rounded-md resize-none"
