    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <div className="text-left mr-8"> {/* Texto al lado izquierdo */}
                <p className="text-xl font-semibold">Our exams prepare you for job opportunity</p>
            </div>

            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-6"> {/* Tarjeta del formulario */}
                <form>
