            ...
            <p className="text-base lg:text-lg dark:text-dark-6 font-popping text-black" style={{ letterSpacing: '-0.01em' }}> Con años de experiencia, nuestros profesores están capacitados para que tengas los mejores resultados posibles.</p>
                ...
                <div className="w-[400px] lg:w-1/3 flex items-center flex-grow ml-32 order-1 lg:order-2 mt-16">
                    <div className="w-full lg:w-2/3 flex justify-center mb-8 lg:mb-0 order-2 lg:order-1">
                        <img src="https://www.openenglish.com/wp-content/uploads/2022/05/prof_character__desktop_x1.png" alt="hero" className="w-full h-auto md:w-[400px] md:h-[350px] lg:w-[600px] lg:h-[400px] xl:w-[900px] xl:h-[500px] transform transition duration-500 ease-in-out hover:scale-105 rounded-lg" />
