            ...
            <div className="content-container py-8 mx-auto relative mb-4 " >
                <div className="flex flex-col-reverse lg:flex-row items-center ml-0 lg:ml-[250px]" >
                    <div className="max-w-xl -mt-8">
                        <h2 className="text-4xl font-bold tracking-tight text-rose-600 sm:text-5xl font-popping text-white mt-12">Habla inglés con fluidez y de forma correcta con los mejores instructores</h2>
                        <p className="mb-2 max-w-[600px] text-lg lg:text-xl dark:text-dark-6 font-popping text-[#F0F4F9]" style={{ letterSpacing: '-0.01em' }}> Aprende a tu ritmo con excelentes instructores capacitados para enseñarte de la mejor manera. Con nuestro método, tendrás una inmersión total en el idioma.</p>
