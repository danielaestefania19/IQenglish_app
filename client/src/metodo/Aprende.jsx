        ...
        <div className="bg-gray-100 py-12">
            <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Mediante sesiones de comunicación activa, los clubes de práctica y el respaldo de tu mentor, avanza hasta que comprendas y desarrolles cada lección al 100%.</p>
                            </div>
                        </div>
                        <div className="flex items-start">
                            <svg className="w-6 h-6 text-blue-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex items-center justify-center">
                    <img src={Computer2} alt="Descripción de la imagen" className="max-w-full"></img>
                </div>
            </div>
        </div>
