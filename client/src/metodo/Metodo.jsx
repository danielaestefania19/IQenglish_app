                    ...
                    <div className="w-full px-4">
                        <div className="mx-auto mb-[60px] max-w-[510px] text-center">
                            ...
                            <p className="text-base text-body-color dark:text-dark-6">
                                El mejor sistema de enseñanza: observando, escuchando y repitiendo, utilizando la mnemotecnia. Lo que nos permitirá tener conversaciones más fluidas en menos tiempo y con menos esfuerzo.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="-mx-4 flex flex-wrap justify-center">
                    ...
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div
                            className="relative z-10 mb-10 overflow-hidden rounded-[10px] border-2 border-stroke bg-white px-8 py-10 shadow-pricing dark:border-dark-3 dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-[50px]"
                        >
                            <span className="mb-0 block text-lg font-semibold text-primary">
                                Business
                            </span>
                            <h2 className="mb-2 text-[42px] font-bold text-dark dark:text-white">
                                <span>Nivel 2</span>
                            </h2>
                            <p
                                className="mb-8 border-b border-stroke pb-8 text-base text-body-color dark:border-dark-3 dark:text-dark-6"
                            ...
                            <div className="mb-9 flex flex-col gap-[14px]">
                                ...
                                <p className="text-base text-body-color dark:text-dark-6">
                                    Participación en 32 clubes de práctica de comunicación activa
                                </p>
                                <p className="text-base text-body-color dark:text-dark-6">
                                    Finalidad: Acostumbrar su oído a los diferentes acentos
                                </p>
                                <p className="text-base text-body-color dark:text-dark-6">
                                    En este nivel contará con las herramientas para desarrollar el idioma más allá de lo cotidiano.
                                </p>
                            </div>
                    ...
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        ...
                        >
                            ...
                            <div className="mb-9 flex flex-col gap-[14px]">
                                <p className="text-base text-body-color dark:text-dark-6">
                                    <strong>Tercer y Último Nivel:</strong>
                                </p>
                                <p className="text-base text-body-color dark:text-dark-6">
                                    Participación en 41 clubes de práctica con contenido audiovisual en inglés
                                </p>
                                <p className="text-base text-body-color dark:text-dark-6">
                                    Nivel avanzado
                                </p>
                                <p className="text-base text-body-color dark:text-dark-6">
                                    Finalidad: Entender, hablar y manejar el idioma de manera dinámica, segura y fluida
                                </p>
                            </div>
