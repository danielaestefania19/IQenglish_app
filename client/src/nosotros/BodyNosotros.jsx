            ...
            <div className="content-container py-8 mx-auto relative mb-4 " >
                <div className="flex flex-col-reverse lg:flex-row items-center ml-0 lg:ml-[250px]" >
                    <div className="max-w-xl">
                        <h2 className="text-4xl font-bold tracking-tight text-rose-600 sm:text-5xl font-popping text-white mt-12">Somos una reconocida escuela de inglés con más de 36 años de experiencia en la enseñanza.</h2>
